...
function Controller() {
    ...
    doOpen ? $.__views.user.addEventListener("open", doOpen) : __defers["$.__views.user!open!doOpen"] = true;
    ...
    $.__views.user.add($.__views.loginText);
    ...
    $.__views.user.add($.__views.lvContainer);
    ...
    $.login.open();
    __defers["$.__views.user!open!doOpen"] && $.__views.user.addEventListener("open", doOpen);
    _.extend($, exports);
}
